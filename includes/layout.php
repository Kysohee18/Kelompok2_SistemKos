    ...
    <nav class="sticky top-0 z-50 bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 gap-4">
                ...
                <a href="?page=home" class="flex items-center gap-2 flex-shrink-0">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    <a href="?page=home" class="hidden md:inline text-sm text-gray-600 hover:text-brand transition">Home</a>
                    <a href="?page=catalog" class="hidden lg:inline text-sm text-gray-600 hover:text-brand transition">Catalog</a>
                    ...
                    <?php if (!empty($_SESSION['user_id'])): ?>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <?php if ($role === 'admin'): ?>
                                <a href="?page=admin_dashboard" class="text-sm text-gray-600 hover:text-brand">
                                    Dashboard
                                </a>

                            <?php elseif ($role === 'user'): ?>
                                <a href="?page=cart" class="text-sm text-gray-600 hover:text-brand">
                                    Cart
                                </a>

                                <a href="?page=orders" class="text-sm text-gray-600 hover:text-brand">
                                    Orders
                                </a>
                            <?php endif; ?>

                            <a href="?page=logout" class="text-sm font-medium text-red-500 hover:text-red-600">
                                Logout
                            </a>
                    ...
                    <?php else: ?>
                        ...
                        <a href="?page=register" class="inline-block border-2 border-brand text-brand hover:bg-brand hover:text-white font-medium text-sm px-5 py-2 rounded-lg transition">
                            Register
                        </a>

                        <a href="?page=login" class="inline-block border-2 border-brand text-brand hover:bg-brand hover:text-white font-medium text-sm px-5 py-2 rounded-lg transition">
                            Masuk
                        </a>
